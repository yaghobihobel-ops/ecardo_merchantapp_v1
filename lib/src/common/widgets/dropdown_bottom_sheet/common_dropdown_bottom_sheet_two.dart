...
class CommonDropdownBottomSheetTwo extends StatefulWidget {
  ...
  final bool showOnlyDisplayName;
...
class _CommonDropdownBottomSheetTwoState
  ...
  void _filterItems(String query) {
    setState(() {
      if (query.isEmpty) {
        ...
        _filteredItems = widget.dropdownItems.where((item) {
          final displayName = widget.showOnlyDisplayName && item.contains('|')
              ? item.split('|').last
              : item;
  ...
  String _getDisplayText(String item) {
    if (widget.showOnlyDisplayName && item.contains('|')) {
